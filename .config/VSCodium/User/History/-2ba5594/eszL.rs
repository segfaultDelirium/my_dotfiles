...
fn zadanie10(){
    ...
    let time_period_day = time_period_hour * 24.0; // in seconds
    ...
    println!("distance_in_hour: {distance_in_hour}");
    println!("distance_in_day: {distance_in_day}");
    println!("distance_in_year: {distance_in_year}");
}
