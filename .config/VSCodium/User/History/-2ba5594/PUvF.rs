...
fn zadanie10(){
    println!("zadanie10");
    let speed = 30.0 * 1000.0; // m/s
    let time_period_hour = 60.0 * 60.0; // in seconds
    let time_period_day = time_period_hour * 24.0; 
    let time_period_year = time_period_day * 365.25;

    let distance_in_hour = speed * time_period_hour;
    let distance_in_day = speed * time_period_day;
    let distance_in_year = speed * time_period_year;

    println!("distance_in_hour: {distance_in_hour / 1000.0} km.");
    println!("distance_in_day: {distance_in_day / 1000.0} km.");
    println!("distance_in_year: {distance_in_year / 1000.0} km.");
}
